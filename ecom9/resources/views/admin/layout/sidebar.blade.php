<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @if (Auth::guard('admin')->user()->type == 'vendor')
            ...
            <li class="nav-item">
                <a @if (Session::get('page') == 'sections' ||
                        ...
                        Session::get('page') == 'filters') style="background: #4B49AC !important; color: #fff !important;" @endif
        ...
        @else
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-admins">
                    <ul class="nav flex-column sub-menu"
                        style="background: #fff !important; color: #4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_admins') style="background: #4B49AC !important; color: #fff !important;"
                        @else style="background: #fff !important; color: #4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/admins/admin') }}"> Admins </a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_subadmins') style="background: #4B49AC !important; color: #fff !important;"
                        @else style="background: #fff !important; color: #4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/admins/subadmin') }}"> Subadmin </a></li>
                        <li class="nav-item"> <a
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-users">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{ url('admin/subscriber') }}"> subscribers
                            </a></li>
            ...
            @endif class="nav-link" data-toggle="collapse" href="#ui-banners" aria-expanded="false" aria-controls="ui-users">
                <i class="icon-head menu-icon"></i>
            ...
            <div class="collapse" id="ui-banners">
                <ul class="nav flex-column sub-menu" style="background: #fff !important; color: #4B49AC !important;">
                    <li class="nav-item"> <a @if (Session::get('page') == 'sections')
                        ...
                        @endif class="nav-link" href="{{url('admin/banners')}}"> Banner </a></li>
            ...
            <li class="nav-item">
                <a @if (Session::get('page') == 'banners') style="background: #4B49AC !important; color: #fff !important;" @endif
                ...
                <div class="collapse" id="ui-banner">
                    <ul class="nav flex-column sub-menu"
                        style="background: #fff !important; color: #4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'banners') style="background: #4B49AC !important; color: #fff !important;"
                        @else style="background: #fff !important; color: #4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/banners') }}"> Home page Banner </a></li>
