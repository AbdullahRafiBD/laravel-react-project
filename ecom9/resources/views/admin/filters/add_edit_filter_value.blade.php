        ...
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              ...
              @endif
                  ...
                  @else
                  action="{{url('admin/add-edit-filter-value/'.$filter['id'])}}"
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="filter_value" name="filter_value" @if (!empty($filter['filter_value']))
                      value="{{$filter['filter_value']}}"
                      @else
                      value="{{old('filter_value')}}"
                      @endif placeholder="Enter filter Value" >
                    </div>
