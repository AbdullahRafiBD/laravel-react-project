        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Filter table</h4>
                            <a href="{{url('admin/add-edit-filter-value')}}" class="btn btn-primary mr-2">Add Filter Value</a>
                            <a href="{{url('admin/filters')}}" class="btn btn-primary mr-2">View Filter</a>
                                    ...
                                    <tbody>
                                        @foreach ($filters_values as $filter)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($filter['status'] == 1)
                                                    <a href="javascript:void(0)" class="updateFilterValueStatus" id="filter-{{$filter['id']}}" filter_id='{{$filter['id']}}'>
