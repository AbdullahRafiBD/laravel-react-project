            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        ...
                        <p id="login-error"></p>
                        <form id="loginForm" action="javascritp:;" method="POST">@csrf
                            <div class="u-s-m-b-30">
                                <label for="user-email"> Email
                                    <span class="astk">*</span>
                                </label>
                                <input type="email" name="email" id="email" id="users-email" class="text-field" placeholder="Email">
                                <p id="login-email"></p>
                            </div>
                            <div class="u-s-m-b-30">
                    ...
                    <div class="reg-wrapper">
                        ...
                        <form id="registerForm" action="javascript:;" method="post">@csrf
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="email" id="user-email" class="text-field" name="email" placeholder="Email">
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="password" id="user-password" class="text-field" name="password" placeholder="User Password">
