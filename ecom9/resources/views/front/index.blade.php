...
<div class="default-height ph-item">
    ...
    <!-- Main-Slider /- -->
    <!-- Banner-Layer -->
    @if (isset($fix_1Banners[0]['image']))
    <div class="banner-layer">
        <div class="container">
            <div class="image-banner">
                <a @if (!empty($fix_1Banners[0]['link']))
                            href="{{url($fix_1Banners[0]['link'])}}"
                        @else
                            href="javascript:void(0)"
                        @endif rel="nofollow" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="{{asset('front/images/banner_images/'.$fix_1Banners[0]['image'])}}" alt="{{$fix_1Banners[0]['alt']}}" title="{{$fix_1Banners[0]['title']}}">
                </a>
            </div>
        </div>
    </div>
                                ...
                                <div class="products-slider owl-carousel" data-item="4">
                                    ...
                                    <div class="item">
                                        <div class="image-container">
                                            <a class="item-img-wrapper-link" href="{{url('product/'.$product['product_url'])}}">
    ...
    <!-- Top Collection /- -->
    <!-- Banner-Layer -->
    @if (isset($fix_2Banners[0]['image']))
    <div class="banner-layer">
        <div class="container">
            <div class="image-banner">
                <a @if (!empty($fix_2Banners[0]['link']))
                            href="{{url($fix_2Banners[0]['link'])}}"
                        @else
                            href="javascript:void(0)"
                        @endif rel="nofollow" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="{{asset('front/images/banner_images/'.$fix_2Banners[0]['image'])}}" alt="{{$fix_2Banners[0]['alt']}}" title="{{$fix_2Banners[0]['title']}}">
                </a>
            </div>
        </div>
    </div>
