            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="thumbnails">
                        <a href="{{ asset('front/images/product_images/large/' . $productDetails['product_image']) }}"
                            data-standard="{{ asset('front/images/product_images/large/' . $productDetails['product_image']) }}">
                        ...
                        @foreach ($productDetails['images'] as $image)
                            <a href="{{ asset('front/images/product_images/large/' . $image['image']) }}"
                                data-standard="{{ asset('front/images/product_images/large/' . $image['image']) }}">
                                <img width="150" height="150"
                    ...
                    <div class="all-information-wrapper">
                        ...
                        @if (isset($productDetails['vendor']))
                            <div class="section-5-product-variants u-s-p-y-14">
                                <div>
                                    Sold By: <a href="{{ url('/products/' . $productDetails['vendor']['id']) }}">
                            ...
                            <div class="tab-pane fade active show" id="description">
                                <div class="description-whole-container">
                                    ...
                                    @if ($productDetails['product_video'])
                                        {{-- <source src="{{url('front/videos/product_videos/'.$productDetails['product_video'])}}" media="(min-width:300px )" srcset="" type="video/mp4"> --}}
                                        ...
                                        <div class="item-content">
                                            <div class="what-product-is">
                                                <ul class="bread-crumb">
                                                    <li class="has-separator">
                                                        <a
                                                            href="{{ url('product/' . $product['product_url']) }}">{{ $product['product_code'] }}</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="{{ url('product/' . $product['product_url']) }}">{{ $product['brand']['name'] }}</a>
                                                    </li>
                                                </ul>
                                                <h6 class="item-title">
                                                    <a
                                                        href="{{ url('product/' . $product['product_url']) }}">{{ $product['product_name'] }}</a>
                                                </h6>
